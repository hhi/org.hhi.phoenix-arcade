...
$$\begin{aligned}
X_{\text{nieuw}} &= X_{\text{oud}} + \Delta X \\
Y_{\text{nieuw}} &= Y_{\text{oud}} + \Delta Y
\end{aligned}$$
...
* **Relevante C-bestanden:**
  - [`phoenix_tables.c`](../phoenix_tables.c) $\rightarrow$ [`phoenix-tables.md`](../c-annotated/phoenix-tables.md)
  - [`alien_logic.c`](../alien_logic.c) $\rightarrow$ [`alien-logic.md`](../c-annotated/alien-logic.md)
  - [`bird_logic.c`](../bird_logic.c) $\rightarrow$ [`bird-logic.md`](../c-annotated/bird-logic.md)
  - [`bird_wave_behavior.c`](../bird_wave_behavior.c) $\rightarrow$ [`bird-wave-behavior.md`](../c-annotated/bird-wave-behavior.md)
  - [`attract_mode.c`](../attract_mode.c) $\rightarrow$ [`attract-mode.md`](../c-annotated/attract-mode.md)
...
| **Einde-Lus Verwerking** | Bij de `0x00` terminator start het patroon naadloos opnieuw vanaf het begin op hetzelfde ankeradres. | Bij de `0x00` terminator of schermrand activeert de game-engine een breakout-herpositionering ([`l3028`](../c-annotated/alien-logic.md#l3028)) of her-oriëntatie ([`l3672_aim`](../c-annotated/bird-wave-behavior.md#l3672_aim)). |
...
2. **Cluster B (ROM `$2C00–$2FFF` / 1024 bytes):**
   ...
   - **Breakout-mechanisme:** De breakout-scheduler [`l3028`](../c-annotated/alien-logic.md#l3028) in `alien_logic.c` springt bij een aanval direct naar de ingangsadressen `$2E00` en `$2E40` in Cluster B.
...
1. **`phoenix_bird_behaviour_scripts` (ROM `$3F00–$3F7F` / 128 bytes):**
   ...
   - Aangeroepen door [`update_bird_behavior`](../c-annotated/bird-wave-behavior.md#update_bird_behavior).
   - **Functies in C:**
...
2. **`phoenix_bird_dive_spawn_positions` (ROM `$3DC0–$3DDF` / 32 bytes):**
   ...
   - Aangeroepen door [`try_spawn_bird_dive_bomb`](../c-annotated/bird-wave-behavior.md#try_spawn_bird_dive_bomb).
...
- **Beschrijving:** Voorgeschreven frame- en bewegingsreeks van 32 stappen voor de vogel die over het titel-scherm zweeft in Attract Mode ([`attract-mode.md`](../c-annotated/attract-mode.md)).
- **Aanroep:** [`draw_intro_bird_animation_frame`](../c-annotated/attract-mode.md#draw_intro_bird_animation_frame) in `attract_mode.c`.
