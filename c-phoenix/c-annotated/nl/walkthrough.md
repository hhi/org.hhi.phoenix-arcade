...
- [`../../animations/nl/animation-trajectory.md`](../../animations/nl/animation-trajectory.md): Diepgaande analyse van alle voorgeschreven vectoriële vliegpatronen, richtingsvectoren, Z80 ROM-clusters en AI-scripts.
- [`../../animations/nl/animation-trajectory-detailed.md`](../../animations/nl/animation-trajectory-detailed.md): Gedetailleerde stap-voor-stap coördinatentabellen op het scherm-grid per individueel patroon (stap #, vector index, dX, dY, cumulatief X/Y).
- [`../../animations/nl/README.md`](../../animations/nl/README.md): Visuele gids en index van alle 68 losse geanimeerde SVG-bestanden (36 alien vector-patronen, 16 vogel AI scripts, 16 vogel duik-spawns, 6 vogel-fases en moederschip-daling).
