...
Source / bron: [Computer Archeology - Phoenix](https://computerarcheology.com/Arcade/Phoenix/).
...
|    |     |     |
| -------- | ------- | ----------------- |
| 4350      | M4350                | Breakout (dive-bomb) state machine step (0-6) |
| 4351      | M4351                | Breakout: new movement pattern pointer MSB |
| 4352      | M4352                | Breakout: new movement pattern pointer LSB |
| 4353      | M4353                | Breakout: pattern-table scan start/limit |
| 4354      | M4354                | Breakout: matched old-pattern pointer position |
| 4355      | M4355                | Breakout: delay timer before arming step 1 |
| 4356      | M4356                | Breakout: old movement pattern pointer LSB (paired with M4394 MSB) |
| 4357      | M4357                | Breakout: count of aliens that broke out this wave pass (max 3) |
| 4358      | M4358                | Breakout: countdown timer before the next dive is armed |
| 4359      | M4359                | ? |
| 435A      | M435A                | ? |
| 435B      | M435B                | ? |
| 435E      | M435E                | ? |
...
| 4364      | M4364                | Flag: kill/score event registered ($FF), set on plain bird/alien kills |
| 4366      | M4366                | Flag: kill/score event registered ($FF), set on egg-transform bird kills and mothership segment hits |
| 4367      | M4367                | Flag for: 'Mothership partially faded in' ($FF) |
| 4368      | M4368                | Bird growth/transform stage bitmask (bits 01/02/04/08 for the L36D2/L36EA/L370A phases, incl. the dive-transform roll) |
| 4369      | M4369                | Flag for:'bonus explosion' ($FF) |
| 436A      | M436A                | ? |
| 436B      | M436B                | Flag for: 'mother ship score display' ($FF) and counter|
| 436D      | M436D                | Bird target/scroll position (also written by sprite rendering) |
| 436E      | M436E                | Bird descent-speed base value, from difficulty inputs |
| 436F      | M436F                | Bird random value, gates dive-transform rolls and B4BD1 climb threshold |
| 4370      | M4370                | Bonus explosion animation array slot: score BCD (high) |
| 4371      | M4371                | Bonus explosion animation array slot: score BCD (low) |
| 4372      | M4372                | Bonus explosion animation array slot: screen ram MSB |
| 4373      | M4373                | Bonus explosion animation array slot: screen ram LSB |
| 4374      | M4374                | ? |
...
| 43E4      | OldPlayerBulletMSB      | Old MSB screen ram: Player bullet |
| 43E5      | OldPlayerBulletLSB      | Old LSB screen ram: Player bullet |
| 43E6      | PlayerBulletMSB         | MSB screen ram: Player bullet |
| 43E7      | PlayerBulletLSB         | LSB screen ram: Player bullet |
| 43E8      | OldAbovePlayerBulletMSB | Old MSB screen ram: One character above player bullet |
| 43E9      | OldAbovePlayerBulletLSB | Old LSB screen ram: One character above player bullet |
| 43EA      | AbovePlayerBulletMSB    | MSB screen ram: One character above player bullet |
| 43EB      | AbovePlayerBulletLSB    | LSB screen ram: One character above player bullet |
...
| 4BC4      | B4BC4                | ? |
| 4BC5      | B4BC5                | ? |
| 4BD1      | B4BD1                | Bird formation climb threshold (compared against B4BD3's countdown) |
| 4BD2      | B4BD2                | Bird formation scroll position, derived each frame from `~CounterB9` |
| 4BD3      | B4BD3                | Bird formation climb-scheduling countdown timer |
| 4BD4      | B4BD4                | Bird formation climb speed table offset |
| 4BD5      | B4BD5                | Bird formation descent speed (from difficulty inputs + M436E) |
| 4BD6      | B4BD6                | Bird formation scroll position, updated from B4BD2 + row deltas |
| 4BD7      | B4BD7                | Bird formation height reference (paired with B4BD6) |
| 4BED      | B4BED                | ? |
| 4BEE      | B4BEE                | ? |
| 4BEF      | B4BEF                | ? |
