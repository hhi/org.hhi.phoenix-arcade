...
> ([`jphoenix_crosscheck.md`](../../mapping/jphoenix_crosscheck.md)) heeft vrijwel
...
> [`c_functions_by_address.md`](../../mapping/c_functions_by_address.md) en de
...
> unieke functies in [`c_functions_by_address.md`](../../mapping/c_functions_by_address.md)
